...
import { createRecipe, getAllRecipes, getRecipeById, updateRecipe, deleteRecipe, generateRecipe, saveRecipe, modifyRecipe, getUserRecipes, filterRecipes } from "../controllers/recipe.controller.js";
...
router.get('/created', protect, getUserRecipes);
