        ...
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} lg={5}>
            <Typography variant="h1" component="h1" className={classes.heading}>
              Meet RecipeBot,{" "}
              <span className={classes.violetText}>the AI in your kitchen</span>
            </Typography>
            <Typography variant="body1" className={classes.paragraph}>
              Generate AI-powered personalized recipes using ingredients in your
              fridge, set dietary preferences, save and share recipes, and even
              make ingredient substitutions. Start cooking delicious meals while
              reducing food waste today.
            </Typography>
            <div>
              <Button
                variant="contained"
