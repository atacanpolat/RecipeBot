  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const recommendedRecipes = recipeService.recommendRecipes(
          recipes,
          userRecipes
        );
        const recommendedRecipesData =
          recipeService.calculateRecipeData(recommendedRecipes);
  ...
  return (
    <div className={classes.container} style={style}>
      <div className={classes.content}>
        ...
        <div
          style={{ width: "1450px", overflowX: "scroll", paddingLeft: "40px" }}
        >
          <Slider
            ref={setSliderRef}
            {...sliderSettings}
